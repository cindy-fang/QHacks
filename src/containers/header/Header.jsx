  ...
  return (
    <div className="eyetunes__header section__padding" id="home">
      <div className="eyetunes__header-content">
        <h1 className="gradient__text">EyeRemember: Redefining Vision-Driven Interaction.</h1>
        <p>EyeRemember is the future of interactivity. With our VR headset program, you can transform any object into a multimedia experience just by looking at it. Say goodbye to traditional interfaces and hello to a world where your gaze is your remote control.</p>
